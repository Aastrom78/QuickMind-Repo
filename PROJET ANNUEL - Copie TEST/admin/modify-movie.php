...
<head>
    ...
    <title>Modifier des extraits vidéo</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <p class="intro-text">Modifier des extraits vidéo</p>
                        <p>Cette interface permet de modifier du contenu multimédia <br>de type Vidéo.</p>
