...
<head>
    ...
    <title>Modifier de la musique</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <p class="intro-text">Modifier de la musique</p>
                        <p>Cette interface permet de modifier du contenu multimédia <br>de type Musique.</p>
